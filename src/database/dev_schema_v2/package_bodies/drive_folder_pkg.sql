create or replace package body dev_schema_v2.drive_folder_pkg is
...
-- sqlcl_snapshot {"hash":"658b4e0eb3d2a5f25d9000c247b5e8ed47c7a0b6","type":"PACKAGE_BODY","name":"DRIVE_FOLDER_PKG","schemaName":"DEV_SCHEMA_V2","sxml":""}