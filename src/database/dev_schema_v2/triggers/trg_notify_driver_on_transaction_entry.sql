create or replace editionable trigger wksp_elwagha50.trg_notify_driver_on_transaction_entry after
    insert on wksp_elwagha50.transaction_entries
    for each row
declare
...
alter trigger wksp_elwagha50.trg_notify_driver_on_transaction_entry enable;


-- sqlcl_snapshot {"hash":"c2ec325bb1cd842572a34017ee39a4ea3061a1ba","type":"TRIGGER","name":"TRG_NOTIFY_DRIVER_ON_TRANSACTION_ENTRY","schemaName":"WKSP_ELWAGHA50","sxml":""}