create or replace editionable trigger wksp_elwagha50.trg_lpa_from_product for
    update of trip_price, exchange_rate on wksp_elwagha50.sublevel_limo_res
compound trigger
...
alter trigger wksp_elwagha50.trg_lpa_from_product enable;


-- sqlcl_snapshot {"hash":"acc8ec4228077d390cd0621c9422e7181399dea9","type":"TRIGGER","name":"TRG_LPA_FROM_PRODUCT","schemaName":"WKSP_ELWAGHA50","sxml":""}