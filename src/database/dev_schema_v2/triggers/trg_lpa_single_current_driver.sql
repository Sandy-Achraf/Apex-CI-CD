create or replace editionable trigger wksp_elwagha50.trg_lpa_single_current_driver for
    insert or update on wksp_elwagha50.limo_product_assignments
compound trigger
...
alter trigger wksp_elwagha50.trg_lpa_single_current_driver enable;


-- sqlcl_snapshot {"hash":"87cda32b2f569c5f5f1c35f1fa3bc0a4645961af","type":"TRIGGER","name":"TRG_LPA_SINGLE_CURRENT_DRIVER","schemaName":"WKSP_ELWAGHA50","sxml":""}