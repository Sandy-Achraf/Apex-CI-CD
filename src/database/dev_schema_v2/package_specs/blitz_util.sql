create or replace package dev_schema_v2.blitz_util as
...
create or replace editionable package body dev_schema_v2.blitz_util as
...
-- sqlcl_snapshot {"hash":"08440a838fe8b29eec1e6dcff90283ba4fed08cc","type":"PACKAGE_SPEC","name":"BLITZ_UTIL","schemaName":"DEV_SCHEMA_V2","sxml":""}