create or replace package dev_schema_v2.utility_invoice_payments as
...
create or replace editionable package body dev_schema_v2.utility_invoice_payments as
...
-- sqlcl_snapshot {"hash":"e13dae2c64d7dbc33aee2deb53a3ce58fadb4f39","type":"PACKAGE_SPEC","name":"UTILITY_INVOICE_PAYMENTS","schemaName":"DEV_SCHEMA_V2","sxml":""}