create or replace package dev_schema_v2.photo_util is
...
create or replace editionable package body dev_schema_v2.photo_util is
...
-- sqlcl_snapshot {"hash":"38def5121a24cec2411cd1efe83866393b11a247","type":"PACKAGE_SPEC","name":"PHOTO_UTIL","schemaName":"DEV_SCHEMA_V2","sxml":""}