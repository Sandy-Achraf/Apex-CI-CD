create or replace package dev_schema_v2.order_router_util as
...
create or replace editionable package body dev_schema_v2.order_router_util as
...
-- sqlcl_snapshot {"hash":"a1a469a870413d3d538116b84211182f5683ba06","type":"PACKAGE_SPEC","name":"ORDER_ROUTER_UTIL","schemaName":"DEV_SCHEMA_V2","sxml":""}