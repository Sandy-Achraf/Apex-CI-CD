create or replace package dev_schema_v2.limo_trip_pkg as
...
create or replace editionable package body dev_schema_v2.limo_trip_pkg as
...
-- sqlcl_snapshot {"hash":"a1a7fc4fc15e0be000703e1880fdfa13d862a5ce","type":"PACKAGE_SPEC","name":"LIMO_TRIP_PKG","schemaName":"DEV_SCHEMA_V2","sxml":""}