create or replace package dev_schema_v2.security_pkg as
...
create or replace editionable package body dev_schema_v2.security_pkg as
...
-- sqlcl_snapshot {"hash":"8b61f14f22390af2fe165d1a34ebffbefd57a8c3","type":"PACKAGE_SPEC","name":"SECURITY_PKG","schemaName":"DEV_SCHEMA_V2","sxml":""}