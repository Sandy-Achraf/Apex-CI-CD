create or replace force editionable view wksp_elwagha50.vw_limo_trip_accounting_json (
    trip_id,
    json_data
) as
    select
...
-- sqlcl_snapshot {"hash":"c96aa6c1ea68108d7fb6b1d1dfced2f1b400a0c1","type":"VIEW","name":"VW_LIMO_TRIP_ACCOUNTING_JSON","schemaName":"WKSP_ELWAGHA50","sxml":""}