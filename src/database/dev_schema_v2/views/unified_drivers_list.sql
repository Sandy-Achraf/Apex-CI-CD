create or replace force editionable view wksp_elwagha50.unified_drivers_list (
    driver_id,
    driver_name,
    assignment_type,
    profile_photo,
...
-- sqlcl_snapshot {"hash":"acf56c73a3fedc1b42da018de7e938f049157e4d","type":"VIEW","name":"UNIFIED_DRIVERS_LIST","schemaName":"WKSP_ELWAGHA50","sxml":""}