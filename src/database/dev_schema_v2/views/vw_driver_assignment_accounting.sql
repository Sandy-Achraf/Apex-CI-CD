create or replace force editionable view wksp_elwagha50.vw_driver_assignment_accounting (
    assignment_end_date,
    assignment_id,
    assignment_note,
    product_id,
...
-- sqlcl_snapshot {"hash":"c239c56f139f7f5e54d4124327042e6616f656e9","type":"VIEW","name":"VW_DRIVER_ASSIGNMENT_ACCOUNTING","schemaName":"WKSP_ELWAGHA50","sxml":""}