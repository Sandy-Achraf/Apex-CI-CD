create or replace editionable trigger wksp_elwagha50.trg_payments_history after
    insert or update or delete on wksp_elwagha50.payments
    for each row
declare
...
alter trigger wksp_elwagha50.trg_payments_history enable;


-- sqlcl_snapshot {"hash":"6c75d507c1867e2c2ea1ada89cbc064037e76a7e","type":"TRIGGER","name":"TRG_PAYMENTS_HISTORY","schemaName":"WKSP_ELWAGHA50","sxml":""}