create or replace editionable trigger wksp_elwagha50.client_contacts_unq_phone_trg before
...
alter trigger wksp_elwagha50.client_contacts_unq_phone_trg enable;


-- sqlcl_snapshot {"hash":"196b07b65d9fe9437dc0a512f8daa1b28c35d641","type":"TRIGGER","name":"CLIENT_CONTACTS_UNQ_PHONE_TRG","schemaName":"WKSP_ELWAGHA50","sxml":""}