create or replace editionable trigger wksp_elwagha50.trg_services_recalc_v2 for
    insert or update or delete on wksp_elwagha50.limo_add_services
compound trigger
    type t_trip_tab is
...
alter trigger wksp_elwagha50.trg_services_recalc_v2 enable;


-- sqlcl_snapshot {"hash":"d3de894a0edd37d243acbc1be56ab79ee98723be","type":"TRIGGER","name":"TRG_SERVICES_RECALC_V2","schemaName":"WKSP_ELWAGHA50","sxml":""}