create or replace force editionable view wksp_elwagha50.v_transaction_history (
    account_id,
    entry_id,
    account_name,
    transaction_date,
...
-- sqlcl_snapshot {"hash":"a88e190796baa2314acbab061b8469d6fc87e133","type":"VIEW","name":"V_TRANSACTION_HISTORY","schemaName":"WKSP_ELWAGHA50","sxml":""}