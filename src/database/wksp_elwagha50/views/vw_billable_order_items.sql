create or replace force editionable view wksp_elwagha50.vw_billable_order_items (
    billing_group_id,
    customer_id,
    main_res_id,
    order_item_id,
...
-- sqlcl_snapshot {"hash":"d3d2a3644a50a4210548d0a5bcf4d4be8cf379a5","type":"VIEW","name":"VW_BILLABLE_ORDER_ITEMS","schemaName":"WKSP_ELWAGHA50","sxml":""}