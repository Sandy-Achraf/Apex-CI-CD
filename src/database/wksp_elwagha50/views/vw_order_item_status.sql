create or replace force editionable view wksp_elwagha50.vw_order_item_status (
    order_item_id,
    main_res_id,
    ref_table,
    ref_id,
...
-- sqlcl_snapshot {"hash":"a489ce23e259e5b82e7af675fe74610380ad10ad","type":"VIEW","name":"VW_ORDER_ITEM_STATUS","schemaName":"WKSP_ELWAGHA50","sxml":""}