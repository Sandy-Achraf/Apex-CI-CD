create or replace force editionable view wksp_elwagha50.vw_driver_dues_balance (
    assignment_id,
    assignment_end_date,
    product_id,
    reservation_id,
...
-- sqlcl_snapshot {"hash":"bebf79f97b3fa94cd6e2564963861d48514a8d7c","type":"VIEW","name":"VW_DRIVER_DUES_BALANCE","schemaName":"WKSP_ELWAGHA50","sxml":""}