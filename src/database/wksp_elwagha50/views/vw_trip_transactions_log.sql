create or replace force editionable view wksp_elwagha50.vw_trip_transactions_log (
    driver_id,
    driver_name,
    driver_phone,
    account_name,
...
-- sqlcl_snapshot {"hash":"a80074f2472dc1013df4c74fca6ac6efb83cc0f2","type":"VIEW","name":"VW_TRIP_TRANSACTIONS_LOG","schemaName":"WKSP_ELWAGHA50","sxml":""}